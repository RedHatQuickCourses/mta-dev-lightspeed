...
* Launch **Visual Studio Code** on your local system. From the lower-left corner, select the **Settings (gear) icon**, and then choose **Extensions** to open the Extensions Marketplace.
+
...
* Once the application is created, copy and securely store the **API Key**, as these values will be required in subsequent configuration steps.
+
image::mas6.png[align="center"]

* Return to the **MTA Analysis view in Visual Studio Code** to configure _Generative AI settings_ as shown below. Make sure to substitute the copied **API Key**.
+
[source,subs="verbatim,quotes",bash]
----
environment:
